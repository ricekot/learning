...
int main(){
    for (int i = 0; i < arr.size();){ 
        ...
        switch(opcode){
            case 1:{
                *parameter(mode[2], i + 3) = *parameter(mode[0], i + 1) + *parameter(mode[1], i + 2);
                i += 4;
                break;
            }
            case 2:{
            ...
            case 7:{
                if (*parameter(mode[0], i + 1) < *parameter(mode[1], i + 2)) *parameter(mode[2], i + 3) = 1;
                else *parameter(mode[2], i + 3) = 0;
                i += 4;
                break;
            }
            case 8:{
...
long long* parameter(int n, int pos){
    switch(n){
        case 0: return &arr[arr[pos]];               // position mode
        case 1: return &arr[pos];                    // immediate mode
        case 2: return &arr[rel_base + arr[pos]];    // relative mode
    }
}
