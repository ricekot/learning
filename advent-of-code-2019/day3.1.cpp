...
vector<int> movedir(vector<vector<int>> &coord, vector<int> pos, char direction, int step){
    int x = pos[0], y = pos[1];
    if (direction == 'U'){
...
vector<vector<int>> plot(vector<string> instructions){
